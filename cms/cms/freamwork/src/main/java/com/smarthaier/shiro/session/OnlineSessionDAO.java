...
import com.smarthaier.common.enums.OnlineStatus;
import com.smarthaier.manager.AsyncManager;
import com.smarthaier.manager.LoginLogRecord;
import com.smarthaier.shiro.service.SysShiroService;
...
public class OnlineSessionDAO extends EnterpriseCacheSessionDAO {
     ...
     */
    @Value("${shiro.user.session.dbSyncPeriod}")
    ...
    public void syncToDb(OnlineSession onlineSession)
    {
        ...
        AsyncManager.me().execute(LoginLogRecord.syncSessionToDb(onlineSession));
    }
    @Override
